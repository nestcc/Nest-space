...
#     u_list = NepUser.objects.filter(groups__name=group).order_by('id')[(page - 1) * limit: page * limit]
#     u_list_at_page = []
#     for each_user in u_list:
#         print(each_user.icon.url)
#         u_list_at_page.append({'id': each_user.id,
...
#         new_user.groups.add(get(name='normal_user'))
#         new_user.save()
#
#         return {'status': 'success'}
#     except Exception as any_exec:
