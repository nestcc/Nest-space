	...
	var menu = {
		...
		submit: function () {
			$(".definite").on("click", function (e) {
				...
				var $listcont = $(this).parents(".form").siblings(".list-cont")
					.length
					? $(this).parents(".form").siblings(".list-cont")
					: $(this).parents(".form-box").siblings(".list-cont");
				console.log($listcont);
				var img = $(this).parents("form").siblings("img").attr("src");
				var textarea = $(this)
					.parents(".layui-form-item")
					.siblings(".layui-form-text")
