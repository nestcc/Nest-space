...
/* ------------------------------------------------------------------ */
$('body').vegas({
    overlay: '/static/assets/ncc_space/img/disk/overlay.png',
    slides: [
        { src: '/static/assets/ncc_space/img/disk/bannerq3.jpg' },
        { src: '/static/assets/ncc_space/img/disk/bannerq2.jpg' },
        { src: '/static/assets/ncc_space/img/disk/bannerq1.jpg' },
    ],
})
